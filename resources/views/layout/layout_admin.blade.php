    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="{{ route('order.management', 0)}}"><i class="feather icon-shopping-cart"></i><span
                            class="menu-title" data-i18n="Email">Quản lý đơn hàng</span></a>
                </li>
                <li class=" nav-item"><a href="/product-management"><i class="fa fa-product-hunt"></i><span
                            class="menu-title" data-i18n="Chat">Quản lý sản phẩm</span></a>
                </li>
                <li class=" nav-item"><a href="/admin-account-management"><i class="feather icon-users"></i><span
                            class="menu-title" data-i18n="Todo">Quản Lý tài khoản</span></a>
                </li>
                <li class="nav-item"><a href="{{ route('slideshow.slideshowManagement') }}"><i class="feather icon-image"></i><span class="menu-title">Quản lý
                            slideshow</span></a>
                </li>
                <li class="nav-item"><a href="{{ route('category.categoryManagement') }}"><i
