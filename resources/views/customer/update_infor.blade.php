                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                            ...
                                            <form novalidate action="{{ route('updateInfor') }}" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="media">
                                                        <a href="javascript: void(0);">
                                                                <img id="image" class="rounded mr-75 @if (empty(Auth::user()->avatar)) hidden @endif" src="{{ asset('img')}}/{{ isset(Auth::user()->avatar) ? Auth::user()->avatar : "" }}" height="64" width="64">
                                                        </a>
                                                        <div class="media-body mt-75">
                                                            <div
                                                                ...
                                                                <input type="file" id="account-upload" name="avatar" onchange="previewFile(this);" hidden>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr><br><br><br>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" id="account-name"
                                                                    placeholder="Name" name="full_name" value="{{ Auth::user()->full_name }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                        ...
                                        <div class="tab-pane fade " id="account-vertical-password" role="tabpanel"
                                            ...
                                            <form novalidate action="/change-password" method="POST">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
