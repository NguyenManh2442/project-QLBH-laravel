...
<div style="text-align: right; margin-top: 20px">
    <a href="/createSlideshow" class="btn bg-gradient-success mr-1 mb-1"><i class="feather icon-plus-square"></i> Add slideshow</a>
 </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table data-thumb-view">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td class="product-img"><img src="{{asset('img')}}/{{ $value->img_slideshow }}" alt="Img placeholder" width="500px" height="300px">
                                                </td>
                                                <td class="product-name">{{ $value->title }}</td>
                                                <td class="product-category">{{ $value->content }}</td>
                                                <td class="product-action">
                                                    <a href="/editSlideshow&id={{ $value->id }}"><i class="feather icon-edit"></i></a>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('slideshow.deleteSlideshow', $value->id) }}" method="post">
                                                                        @method('delete')
