...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('css/app-assets/css/core/menu/menu-types/vertical-menu.css')}}">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{asset('css/app-assets/images/pages/login.png')}}" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form action="/signinAdmin" method="post">
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control" name="email" id="user-name" placeholder="E-mail" required>
                                                    ...
                                                    <button type="submit"
                                                    class="btn btn-primary float-right btn-inline">Login</button>                                                </form>
                                            </div>
                                        </div>
